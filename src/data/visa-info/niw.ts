  ...
  en: {
    ...
    processSteps: [
      ...
      },
      {
        ...
        description:
          'When your priority date is current, file I-485 (Adjustment of Status) if in the US, or undergo consular processing if abroad. Concurrent filing with I-140 may be possible if dates are current.',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes. A dual-track strategy is common — filing NIW (self-petition) alongside a PERM-based EB-2 or EB-3 through your employer. This hedges against processing delays or denial on either track.',
      },
      {
  ...
  zh: {
    ...
    processSteps: [
      ...
      },
      {
        ...
        description:
          '当优先日期排到时，如在美国境内可提交I-485（身份调整）；如在境外则进行领事处理。如果排期已排到，可能可以与I-140同时提交。',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          '可以。双轨策略很常见——同时提交NIW（自行申请）和通过雇主的PERM-based EB-2或EB-3申请，以对冲任何一条途径的审理延迟或拒签风险。',
      },
      {
        question: 'NIW的批准率是多少？',
        answer:
